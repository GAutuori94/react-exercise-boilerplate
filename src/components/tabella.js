...
export class Table extends React.Component {
  ...
  const filterd = this.state.list.filter((item) => text.toLowerCase() === "" || item.first_name.toLowerCase().includes(text) || item.first_name.includes(text) || item.last_name.toLowerCase().includes(text) || item.last_name.includes(text) || item.phone.includes(text))
